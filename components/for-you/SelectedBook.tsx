  ...
  return (
    <section className="mb-10">
      ...
      <div className="max-w-[680px] bg-[#fbefda] rounded-md flex flex-col md:flex-row items-start gap-4 md:gap-8 px-8 py-8">
        <p className="md:hidden text-brand-navy font-base">{book.subTitle}</p>

        <p className="hidden md:block text-brand-navy font-base flex-1 max-w-[220px]">
          {book.subTitle}
        </p>
        ...
        >
          ...
          />
          <div>
            <div className="font-bold text-brand-navy">{book.title}</div>
